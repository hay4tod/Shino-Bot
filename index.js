...
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `Bot Created By Yuuu\n`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;RamaaBot,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/3c485ff201d9337be14ef.jpg' }}}}
...
{title: "📮 𖢉 YouTube", rowId: prefix+"yt", description: "YouTube Premium 4 Bulan"},
...
case 'groupadmin':
	ramz.sendMessage(from, 
{text: `*Group Hayato Store*\n
Group1 :https://chat.whatsapp.com/F8r8aVeEl7PAiQyAmzIrmr`},
{quoted: msg})
break
...
OK, thanks udah order di *Hayato Store*
`
ramz.sendMessage(from, { image: fs.readFileSync(`./gambar/qris.jpg`),
 caption: tekssss, 
footer: `${setting.ownerName} © 2022`},
...
💎706 ( 625+81 ) = 159.000
💎792 ( 703+89 ) = 178.000
💎1412 ( 1250+162 ) = 315.000
💎2195 ( 1860+335 ) = 470.000*
...
let tek = (`「 *TRANSAKSI BERHASIL* 」\n\n\`\`\`📆 TANGGAL : ${tanggal}\n⌚ JAM     : ${jam}\n✨ STATUS  : Berhasil\`\`\`\n\nTerimakasih Telah order di *Hayato Store*\nNext Order ya🙏`)
let btn_menu = [
{buttonId: `${prefix}aokeguwgw`, buttonText: { displayText: 'OKE THANKS👍' }, type: 1 },
]
ramz.sendMessage(from,
{text: tek,
buttons: btn_menu})
